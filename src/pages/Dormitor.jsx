...
function Dormitor() {
  ...
  const images = [
      "/images/images-bedroom/p11.jpg",
      "/images/images-bedroom/p12.jpg",
      "/images/images-bedroom/p13.jpg",
      "/images/images-bedroom/p14.jpg",
      "/images/images-bedroom/p15.jpg",
      "/images/images-bedroom/p16.jpg",
  ];
  ...
  return (
    <div style={{ fontFamily: "Arial, sans-serif", color: "#333", lineHeight: 1.6 }}>
      ...
      >
        Spațiul tău de relaxare, confort și intimitate.
      </motion.p>
      ...
      >
        <h2 style={{ marginBottom: "20px", fontSize: "2rem", color: "#6b1f3f" }}>Sanctuarul personal</h2>
        <p style={{ marginBottom: "20px", fontSize: "1.1rem" }}>
          Dormitorul este locul unde te retragi după o zi lungă. La Dagi Deluxe, creăm mobilier care combină funcționalitatea cu eleganța, asigurând confort maxim și armonie vizuală.
        </p>

        <h3 style={{ marginBottom: "15px", fontSize: "1.5rem" }}>Capcana seturilor standard</h3>
        <p style={{ marginBottom: "20px", fontSize: "1.1rem" }}>
          Mobilierul standard poate aglomera camera și nu se potrivește cu arhitectura existentă. Noi proiectăm piese personalizate care optimizează spațiul și creează un ambient relaxant.
        </p>

        <h3 style={{ marginBottom: "15px", fontSize: "1.5rem" }}>Echilibrul Dagi Deluxe</h3>
        <p style={{ fontSize: "1.1rem" }}>
          Materiale durabile, soluții de depozitare inteligente și finisaje rafinate transformă dormitorul într-un spațiu funcțional și elegant.
        </p>
      </motion.div>
      ...
      >
        ...
        <p style={{ marginBottom: "20px", fontSize: "1.1rem" }}>
          Dormitorul tău merită atenție și personalizare. Colaborarea cu Dagi Deluxe oferă avantaje pe care producția de masă le ignoră.
        </p>

        <h3 style={{ marginBottom: "15px", fontSize: "1.5rem" }}>Integrare arhitecturală</h3>
        <p style={{ marginBottom: "20px", fontSize: "1.1rem" }}>
          Creăm mobilier care se potrivește perfect cu dimensiunile și forma dormitorului.
        </p>
        ...
        <p style={{ marginBottom: "20px", fontSize: "1.1rem" }}>
          Tu alegi culorile și finisajele, noi ne asigurăm că dormitorul arată elegant și armonios.
        </p>
      </motion.div>
      ...
      >
        ...
        <p style={{ marginBottom: "20px", fontSize: "1.1rem" }}>
          Imaginează-ți o seară relaxantă în dormitorul tău, cu totul la locul său și o atmosferă calmă și primitoare.
        </p>
        <p style={{ marginBottom: "20px", fontSize: "1.1rem" }}>
          Nu trebuie să alegi mobila astăzi. Dar dacă simți că dormitorul tău poate fi mai mult decât un simplu spațiu de odihnă, suntem aici să explorăm opțiunile.
        </p>
        <p style={{ fontSize: "1.1rem" }}>
